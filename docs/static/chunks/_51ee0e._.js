(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_51ee0e._.js", {
...
"[project]/app/components/SoundCloudPlayer.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function SoundCloudPlayer() {
    ...
    const hasAutoTriedRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    const unmuteOnFirstInteractionRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(true);
    // Pick a random start track index on mount
    const startTrackIndex = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SoundCloudPlayer.useMemo[startTrackIndex]": ()=>Math.floor(Math.random() * 10)
    }["SoundCloudPlayer.useMemo[startTrackIndex]"], []); // fallback upper bound; corrected after READY
    // Build iframe src with minimal classic player UI
    const playerSrc = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SoundCloudPlayer.useMemo[playerSrc]": ()=>{
        ...
        "SoundCloudPlayer.useEffect": ()=>{
            ...
            function initWidget() {
                ...
                widget.bind(window.SC.Widget.Events.READY, {
                    "SoundCloudPlayer.useEffect.initWidget": ()=>{
                        if (cancelled) return;
                        setIsReady(true);
                        ...
                        widget.getSounds({
                            "SoundCloudPlayer.useEffect.initWidget": (sounds)=>{
                        ...
                        if (!hasAutoTriedRef.current) {
                            ...
                            setTimeout({
                                "SoundCloudPlayer.useEffect.initWidget": ()=>{
                                    widget.isPaused({
                                        "SoundCloudPlayer.useEffect.initWidget": (paused)=>{
                                            if (paused) {
                                                try {
                                                    widget.play();
                                                } catch  {}
                            ...
                            }["SoundCloudPlayer.useEffect.initWidget"], 600);
                        }
                    }
                }["SoundCloudPlayer.useEffect.initWidget"]);
                widget.bind(window.SC.Widget.Events.PLAY, {
                    "SoundCloudPlayer.useEffect.initWidget": ()=>{
                        ...
                        widget.getCurrentSound({
                            "SoundCloudPlayer.useEffect.initWidget": (sound)=>setCurrentTitle(sound?.title || '')
                        }["SoundCloudPlayer.useEffect.initWidget"]);
                    }
                }["SoundCloudPlayer.useEffect.initWidget"]);
                ...
                const resumeFromGesture = {
                    "SoundCloudPlayer.useEffect.initWidget.resumeFromGesture": ()=>{
                        if (!unmuteOnFirstInteractionRef.current) return;
                        unmuteOnFirstInteractionRef.current = false;
                        try {
                            widget.setVolume(50);
                            widget.isPaused({
                                "SoundCloudPlayer.useEffect.initWidget.resumeFromGesture": (paused)=>{
                ...
                window.addEventListener('touchstart', resumeFromGesture, {
                    once: true
                });
            }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "fixed bottom-4 right-4 z-40 flex items-center gap-3 glass-dark border border-white/10 rounded-xl p-3 shadow-lg",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("iframe", {
                ...
                fileName: "[project]/app/components/SoundCloudPlayer.tsx",
                lineNumber: 186,
                columnNumber: 7
            }, this),
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: currentTitle || 'SoundCloud Player'
            }, void 0, false, {
                fileName: "[project]/app/components/SoundCloudPlayer.tsx",
                lineNumber: 212,
                columnNumber: 7
...
_s(SoundCloudPlayer, "hEMMmoq0xvr5ULv2v8B7jZh0IoM=");
_c = SoundCloudPlayer;
var _c;
...
//# sourceMappingURL=_51ee0e._.js.map